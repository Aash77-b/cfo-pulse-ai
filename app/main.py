...
# Add the current directory to path so Python finds modules
...
with st.sidebar:
    ...
    try:
        from utils.ocr_engine import TESSERACT_AVAILABLE
        if TESSERACT_AVAILABLE:
            st.success("✅ OCR Ready")
        else:
            st.warning("⚠️ OCR Limited")
    except:
        st.info("📷 OCR Status Unknown")
